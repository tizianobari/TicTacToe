			...
			<div class="row"align="center">
				...
				<form action="index.php" method="post">
					<div class="form-group col-md-2 text-center bg-warning text-info">
						...
						<br>
						<input type="text" name="nome2" value="<?php echo $grill->namePlayer2;?>" <?php echo $grill->namePlayer2 != "" ? "readonly" : "" ?> > :  
					...
					<div class="form-group col-md-2 text-center bg-warning text-info">
						...
						<?php
							...
							//echo $grill->winner ? ( $grill->turno%2 == 0 ? "Vincitore <b>".$grill->player1->name."-".$grill->player1->option."</b><br>" : "Vincitore <b>".$grill->player2->name."-".$grill->player2->option."</b><br>" ) : ( $grill->turno >= 9 ? "<b> PARITA' </b> <br>" : "<br>" )
							echo $grill->winner ? "Vincitore: <b>".$grill->giocatoreAttuale->name ."</b>" : ( $grill->turno >= 9 ? "<b> Parita' </b> <br>" : "<br>");
						?>
